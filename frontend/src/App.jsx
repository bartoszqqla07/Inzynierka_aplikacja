        ...
        <>
          <header className="sticky top-0 z-20">
            <div className="mx-auto w-full max-w-6xl px-3 pt-3 sm:px-4 sm:pt-4">
              <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 rounded-2xl border border-slate-200/60 bg-white/60 px-3 py-3 shadow-sm backdrop-blur sm:grid-cols-[minmax(0,1fr)_auto] sm:rounded-3xl sm:px-5 sm:py-4">
