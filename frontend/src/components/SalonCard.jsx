      ...
      <div
        ...
        onKeyDown={(event) => {
          if (event.key === "Enter" || event.key === " ") {
            ...
            window.location.href = `/salons/${salon.id}`;
          }
        }}
        className="flex h-full cursor-pointer flex-col items-center gap-4 p-5 outline-none focus-visible:ring-2 focus-visible:ring-teal-300"
      >
