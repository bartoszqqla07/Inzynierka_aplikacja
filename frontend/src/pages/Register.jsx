...
export default function Register() {
  ...
  const handleSignup = async (event) => {
    ...
    setInfoMsg("Sprawdz email, aby potwierdzic konto.");
  };
    ...
    <>
      ...
      <div className="fixed inset-0 z-30 flex items-center justify-center px-4">
        ...
        <div className="relative w-full max-w-md rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-[0_24px_80px_rgba(15,23,42,0.28)] sm:p-8">
          ...
          <div className="text-xs uppercase tracking-wide text-slate-400">Rejestracja</div>
          <h1 className="mt-2 text-2xl font-semibold text-slate-900">Utworz konto</h1>

          <form className="mt-6 grid gap-3 text-left" onSubmit={handleSignup}>
            {errorMsg ? (
